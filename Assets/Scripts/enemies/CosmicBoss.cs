...
namespace level5
{
    using CosmicBossType = BaseEnemy<CosmicBossConfig, CosmicBossComponents>;

    public class CosmicBoss : CosmicBossType
    {
        [HideInInspector] public CosmicBossState state;
        ...
        protected override void InitializeStateMachine()
        {
            ...
            state = new CosmicBossState();

            var idleState = new CommonIdleState<CosmicBossType>();
            var chasePlayerState = new CommonChasePlayerState<CosmicBossType>();
            var attack1State = new CosmicAttack1State();
            var attack2State = new CosmicAttack2State();
            var attack3State = new CosmicAttack3State();
            var spawnState = new CosmicSpawnState();
            var takeDamageState = new CosmicTakeDamageState();
            var deathState = new CommonDeathState<CosmicBossType>();
            ...
            stateMachine.AddTransition(takeDamageState, () =>
            {
                if (takeDamageState.DamageAnimationComplete)
                {
                    ...
                    if (previousState is CosmicSpawnState spawnState && !spawnState.SpawnComplete)
                    {
            ...
            stateMachine.SetInitialState<CommonIdleState<CosmicBossType>>();
        ...
        public override void OnPlayerAttack()
        {
            ...
            if (stateMachine.CurrentState is CosmicTakeDamageState)
            {
                return;
            }
            ...
            if (lives <= 0)
            {
                stateMachine.ChangeState<CosmicTakeDamageState>();
                return;
            }
        ...
        public override void CompleteTakeDamage()
        {
            ...
            if (stateMachine.CurrentState is CosmicTakeDamageState takeDamageState)
            {
        ...
        public void Anim_OnMove()
        {
            PlayAudioClip(Config.engineSFX);
        }

        public void OnSpawnEnd()
        {
            if (stateMachine.CurrentState is CosmicSpawnState spawnState)
            {
    ...
    public class CosmicAttack1State : State<CosmicBossType>
    {
        ...
        public override void Enter()
        {
            ...
            owner.Components.Animator.SetTrigger(CosmicBoss.Kick);
            (owner as CosmicBoss).state.Attack1Count++;
        ...
        {
            CosmicBoss CosmicBoss = owner as CosmicBoss;
    ...
    public class CosmicAttack2State : State<CosmicBossType>
    {
        public bool AttackComplete { get; private set; }
        ...
        public override void Enter()
        {
            ...
            float direction = owner.Player.transform.position.x < owner.transform.position.x ? -1 : 1;
            owner.transform.rotation = Quaternion.Euler(0, direction == -1 ? 0 : 180, 0);
            owner.Components.Animator.SetTrigger(CosmicBoss.Punch);
    ...
    public class CosmicAttack3State : State<CosmicBossType>
    {
        public bool AttackComplete { get; private set; }
        ...
        public override void Enter()
        {
            ...
            float direction = owner.Player.transform.position.x < owner.transform.position.x ? -1 : 1;
            owner.transform.rotation = Quaternion.Euler(0, direction == -1 ? 0 : 180, 0);
            owner.Components.Animator.SetTrigger(CosmicBoss.GroundSlam);
        ...
        public override void EndState()
        {
            ...
            float direction = owner.Player.transform.position.x < owner.transform.position.x ? -1 : 1;
            owner.transform.rotation = Quaternion.Euler(0, direction == -1 ? 0 : 180, 0);
            owner.Components.Animator.Play(CosmicBoss.Punch, -1, 0);
    ...
    public class CosmicSpawnState : State<CosmicBossType>
    {
        public bool SpawnComplete { get; private set; }
        private State<CosmicBossType> _nextState;
        ...
        public override void Enter()
        {
            ...
            float direction = owner.Player.transform.position.x < owner.transform.position.x ? -1 : 1;
            owner.transform.rotation = Quaternion.Euler(0, direction == -1 ? 0 : 180, 0);
            owner.Components.Animator.SetTrigger(CosmicBoss.Spawn);

            owner.SetDirection(direction);
        }

        public State<CosmicBossType> GetNextState()
        {
            return _nextState;
        }
        ...
        {
            SpawnComplete = false;
            (owner as CosmicBoss).state.ShouldSpawn = false;
        }
    }

    public class CosmicTakeDamageState : CommonTakeDamageState<CosmicBossType>
    {
        ...
        public override void Enter()
        {
            ...
            owner.TakeDamage();
            if (owner.GetLives() <= 0 && stateMachine.HasState<CommonDeathState<CosmicBossType>>())
            {
                stateMachine.ChangeState<CommonDeathState<CosmicBossType>>();
                return;
            }
            ...
            _elapsedTime = 0f;
            CosmicBoss CosmicBoss = owner as CosmicBoss;
            CosmicBoss.spriteRenderer.color = CosmicBoss.Config.DamageFlashColor;
        }
        ...
        public override void Update()
        {
            ...
            CosmicBoss CosmicBoss = owner as CosmicBoss;
            float t = _elapsedTime / CosmicBoss.Config.FlashDuration;
            CosmicBoss.spriteRenderer.color = Color.Lerp(CosmicBoss.Config.DamageFlashColor, CosmicBoss.originalColor, t);
        ...
        public override void Exit()
        {
            ...
            CosmicBoss mechBoss = owner as CosmicBoss;
            mechBoss.spriteRenderer.color = mechBoss.originalColor;
        }
    }

    [System.Serializable]
    public class CosmicBossConfig : EnemyConfig
    {
    ...
    [System.Serializable]
    public class CosmicBossComponents : EnemyComponents
    {
    }

    public class CosmicBossState
    {
        public bool ShouldSpawn { get; set; }
        public int Attack1Count { get; set; }
        public int RemainingAttacks { get; set; }

        public CosmicBossState()
        {
            ShouldSpawn = false;
            Attack1Count = 0;
            RemainingAttacks = 0;
